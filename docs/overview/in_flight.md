...
| 🟣 検証待ち | v0.3.0 の門 (リリース範囲と実施順序) | チェックリスト §1〜§3、アップグレード検証の段 1・段 2、Playbook 全置き換え (§9-L、マージ済み) まで済み。次 = 段 3 (update.bat 経路の検証) と §4 の観察走行を経て、リリース判定点の裁定をまはーと行う。リリース時の必須作業 = dev6→0.3.0 の空エッジ追加。 | まはー (判定) | [v030_release_gate.md](v030_release_gate.md) / [アップグレード検証](../handoff/2026-08-29_v0229_upgrade_test.md) | 2026-08-25 |
