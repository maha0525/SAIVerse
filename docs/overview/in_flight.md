...
| 🟣 検証待ち | v0.3.0 の門 (リリース範囲と実施順序) | 掃討消化済み・develop 統合済み・リリースブランチ (release/v0.3.0、空エッジ + VERSION 収録) から main への PR #271 を作成済み (本文にリリースノート草稿と残作業チェックリスト)。次 = まはーが PR #271 をマージ → タグ v0.3.0 + GitHub Release (アップデート手順を本文へ) → ZIP 作成時に Git 自動導入のクリーン実機テスト。 | まはー (マージとタグ) | [v030_release_gate.md](v030_release_gate.md) / [PR #271](https://github.com/maha0525/SAIVerse/pull/271) | 2026-09-01 |
