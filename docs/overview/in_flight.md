...
| 🔵 設計中 | スルースの被覆の穴 — 会話を止めない採取と後から拾える記録 | intent 起草と文書レビュー 2 種の反映まで完了。次 = 未決 4 点 (パンマーカー頭打ちの撤回・読み戻しの巨大単位の直し方・リリース範囲・前置き例文) のまはー裁可 → 第一段の実装。 | まはー (未決の裁可) | [intent](../intent/sluice_coverage_gaps.md) | 2026-09-08 |
