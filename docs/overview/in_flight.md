...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | Wave 1 が完了した (episode.md v1.4 確定 — エピソードとチャンクの二概念 + メッセージへの記録に着地)。想起での使い方と連続性グラフの改名・ノード再設計は §2-2 / §2-14 の宿題へ引き継ぎ済み。次 = Wave 2 (モデル格と保温、生ログ正史を含む) の設計議論を開く。 | まはー (Wave 2 の設計議論) | [v030_release_gate.md](v030_release_gate.md) / [episode.md](../intent/episode.md) | 2026-08-11 |
