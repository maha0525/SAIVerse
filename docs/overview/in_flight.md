...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | Wave 2 の設計議論で自律行動 v3 (台帳と Beat の一日) の骨格裁定が出揃い、intent たたき台に収録した。次 = まはーがたたき台 ([autonomous_behavior_v3.md](../intent/autonomous_behavior_v3.md)) を文面レビューし、§9 未決 (タグのスキーマ・保温計測・Beat 境界知覚ほか) の扱いを決める。 | まはー (v3 たたき台の文面レビュー) | [v030_release_gate.md](v030_release_gate.md) / [autonomous_behavior_v3.md](../intent/autonomous_behavior_v3.md) | 2026-08-12 |
