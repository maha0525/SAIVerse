...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | Wave 0 の実装とレビュー消し込みは完了し、レビューから設計裁定が要る 4 件が別 doc へ切り出されている。次 = まはーが設計議論一本目 (エピソードの単位) を開ける。Wave 0 に残るのは head 規約文の文言レビューとクオンのデータ修復で、いずれもまはー待ち。 | まはー (設計議論 / 文言レビュー) | [v030_release_gate.md](v030_release_gate.md) / [ハンドオフ](../handoff/2026-08-09_wave0_review_handoff.md) | 2026-08-09 |
