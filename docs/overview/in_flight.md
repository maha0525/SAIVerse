...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | episode.md v1.0 の全面改稿が完了し、Wave 1 の議題はすべて裁定済みになった。次 = まはーが v1.0 を通読レビューして Wave 1 を締め、Wave 2 (モデル格と保温、生ログ正史を含む) の設計議論を開く。 | まはー (v1.0 レビュー → Wave 2) | [v030_release_gate.md](v030_release_gate.md) / [episode.md](../intent/episode.md) | 2026-08-11 |
