...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | Wave 1 第一夜が完了し、エピソードの骨格 (器と縁・時計の退場・中断状態) と Track 撤廃 (§2-16 編入・裁定 3 点決着) が確定した。次 = Wave 1 の残り (編纂対象規則・AUTONOMOUS 化再裁定・episode.md v1.0 改稿) の設計議論を続ける。 | まはー (設計議論の続き) | [v030_release_gate.md](v030_release_gate.md) / [track_retirement.md](../intent/track_retirement.md) | 2026-08-10 |
