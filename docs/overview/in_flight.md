...
|---|---|---|---|---|---|
| 🟠 実装中 | 上限の小さいモデルに切り替えると記憶の整理から抜け出せない (スルースを飛ばす判定が、実際に送る量を見ていない) | 修正方針は GO 済みで、実装を委譲している。次は検収と隔離環境での通し確認、レビューを経て PR を出す。 | 私 | [issue](../issues/sluice_skip_ignores_model_context.md) | 2026-09-17 |
