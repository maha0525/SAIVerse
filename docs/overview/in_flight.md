...
|---|---|---|---|---|---|
| 🟠 実装中 | 送る量の一系統化と会話以外の内容の節約 (v0.3.12 本丸) | 縮める規則 (設計 1・2 = 操作通知を下ろす / 現在地でない部屋を縮める) は実装と契約テストまで済み、まはーの検収待ち。次はしきい値の一系統化と廃止、プリセットの画面、正典の書き直し。 | まはー (縮みの検収) | [presented_context_reduction.md](../intent/presented_context_reduction.md) | 2026-09-09 |
