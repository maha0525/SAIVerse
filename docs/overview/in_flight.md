...
| 🟢 実装中 | v0.3.0 の門 (リリース範囲と実施順序) | Wave 1 第二夜まで完了し、編纂対象規則 (機構名義は 500 字閾値+決定論圧縮で編纂に乗せる) が裁定済み。生ログ正史と作業ダイジェスト経路は Wave 2 へ移動。次 = Wave 1 の残り (小物 3 件と episode.md v1.0 改稿) を片づけて Wave 2 (モデル格と保温) を開く。 | まはー (設計議論の続き) | [v030_release_gate.md](v030_release_gate.md) / [track_retirement.md](../intent/track_retirement.md) | 2026-08-11 |
