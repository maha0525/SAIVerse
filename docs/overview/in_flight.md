...
| 🟠 実装中 | Chronicle の被覆の穴 — 詰まらない統合と確定を装わない記録 | intent はレビュー 2 種を反映してまはー確定済み。次 = 第一段 (跨ぎ統合・上位への繋ぎ直し・両方向吸収・単独編纂・内訳報告・診断内訳) を実装する。 | 私 (実装) | [intent](../intent/chronicle_coverage_gaps.md) | 2026-09-08 |
