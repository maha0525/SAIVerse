...
| 🟣 検証待ち | v0.3.0 の門 (リリース範囲と実施順序) | チェックリスト §1〜§3 とアップグレード検証の段 1 (v0.2.29) ・段 2 (3 月の本番バックアップ、二都市 16 人) まで合格済み。次 = 段 3 (update.bat 経路) と §9-L の裁定、§4 の観察走行を経てリリース判定点へ。 | まはー (判定) | [v030_release_gate.md](v030_release_gate.md) / [アップグレード検証](../handoff/2026-08-29_v0229_upgrade_test.md) | 2026-08-25 |
