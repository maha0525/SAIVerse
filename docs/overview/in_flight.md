...
| 🔵 設計中 | v0.3.0 の門 (リリース範囲と実施順序) | 全域棚卸しから門 v1 (§2 = 14 件) と実施順序 §7 を起草済み、境界件の裁定も反映済み。次 = まはーのレビュー (§7 の裁定点 4 つ、特に ScheduleManager 除籍の再裁定) → 設計議論の一本目 (エピソードの単位) を開く。 | まはー (レビュー) | [v030_release_gate.md](v030_release_gate.md) | 2026-08-09 |
