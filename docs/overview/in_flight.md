...
|---|---|---|---|---|---|
| 🔵 設計中 | 送る量の一系統化と会話以外の内容の節約 (v0.3.12 本丸) | intent はまはーのレビュー中で、数字の入口は 3 プリセット + カスタムで裁定済み。次は残る 2 点 (よその部屋の節約の割り切り / スペルの結果の扱いをこの版でやるか) の裁定をもらい、プリセットの数字の案を出して実装に入る。 | まはー (残る 2 点の裁定) | [presented_context_reduction.md](../intent/presented_context_reduction.md) | 2026-09-09 |
