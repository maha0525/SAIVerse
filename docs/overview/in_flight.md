...
|---|---|---|---|---|---|
| 🟣 検証待ち | 移動の瞬間に積む知覚通知の是正 (v0.3.10 主案件) | 実機検証は全項目合格 (往復の静けさ・退室の即時視認・想起の一回きり・偽剥奪の消失)。次 = PR を develop へ出してまはーの内容確認 → v0.3.10 発行の束へ。 | まはー (PR 確認) | [issue](../issues/perception_state_pushed_at_event_time.md) | 2026-09-07 |
