...
| 🟣 検証待ち | v0.3.0 の門 (リリース範囲と実施順序) | チェックリスト §1〜§3、アップグレード検証の段 1・段 2、§9-L の Playbook 全置き換え実装 (保険ブランチ、実機二本合格) まで済み。次 = まはーが保険ブランチのマージを判断し、段 3 (update.bat 経路) と §4 の観察走行を経てリリース判定点へ。 | まはー (マージ判断) | [v030_release_gate.md](v030_release_gate.md) / [アップグレード検証](../handoff/2026-08-29_v0229_upgrade_test.md) | 2026-08-25 |
