...
|---|---|---|---|---|---|
| 🔵 設計中 | 送る量の一系統化と会話以外の内容の節約 (v0.3.12 本丸) | まはーレビューで決めることの 3 点 (プリセット化 / よその部屋の割り切り / スペルの結果は後回し) が裁定済み。次はプリセットの数字の案を出して確認をもらい、実装に入る。 | 私 (数字案) → まはー (確認) | [presented_context_reduction.md](../intent/presented_context_reduction.md) | 2026-09-09 |
