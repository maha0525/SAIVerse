...
| 🟣 検証待ち | v0.3.0 の門 (リリース範囲と実施順序) | チェックリスト §1〜§3 とアップグレード検証の段 1 (v0.2.29 からの跳び、起動不能欠陥の修理込み) まで合格済み。次 = 段 2 (4 月バックアップからの遠距離跳び — まはーの発掘待ち) と段 3 (update.bat 経路)、§9-L の裁定、§4 の観察走行を経てリリース判定点へ。 | まはー (バックアップ発掘・判定) | [v030_release_gate.md](v030_release_gate.md) / [アップグレード検証](../handoff/2026-08-29_v0229_upgrade_test.md) | 2026-08-25 |
