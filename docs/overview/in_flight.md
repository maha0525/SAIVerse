...
|---|---|---|---|---|---|
| 🔵 設計中 | ⑥ 概念再編（九龍城の解体） | 大物＝記憶概念の統合 → **Memory Atlas**(土地=生ログ/地図帳=編纂物/写真=統一参照)。概念骨格確定・**実装順序 v0.1 合意済(2026-07-10)**: P1写真 → P2ファサード+統一スペル → P3物理統合(コア記憶→Chronicle→目的の木) → P4代謝配線。①との交差は **(i) P3cを①実機テストより先に**で確定。**P1 / P2a / P2b=実装済**(DeskSection+snapshot_desk 含む。soft-delete 素通しバグを検収で発見・修正、テスト最終確認中→コミットで P2b 完了)。**P2c 消費者監査=Codex 完了** ([handoff](../handoff/2026-07-10_memory_atlas_p2c_consumer_audit.md): 旧26ツール・一括削除不可・現役機械消費者あり)。次: **P2c-0 の4決定**(削除動詞/転写/ページ作成/候補生成)=まはー議論 | まはー(P2c-0) + 私(P2b コミット) | [concept_consolidation.md](../intent/concept_consolidation.md) / [life_concept_map.md](../intent/persona_cognition/life_concept_map.md) | 2026-07-10 |
