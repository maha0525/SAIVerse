...
> **ステータス: 検証待ち (2026-09-16 起草・同日実装・同日実機体感) — 実験的機能として develop にマージ済み (PR #302)、実機確認待ち**。まはーの実機体感で機能として成立していることは確認済み。ただし「通話の会話はまだ浅く、ペルソナの人格が出ているとは言い難い」(2026-09-16 まはー) ため、**入口は開発者モードのときだけ表示する実験的機能**として取り込み、育てていく。
