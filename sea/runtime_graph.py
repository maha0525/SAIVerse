...
def compile_with_langgraph(
    ...
    compiled = compile_playbook(
        ...
        tool_node_factory=lambda node_def: runtime._lg_tool_node(node_def, persona, playbook, event_callback),
        tool_call_node_factory=lambda node_def: runtime._lg_tool_call_node(node_def, persona, playbook, event_callback),
