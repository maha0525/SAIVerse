...
PROVIDER_PRESETS: Dict[str, Dict[str, Optional[str]]] = {
    "gemini_paid": {
        ...
        "audio_summary_model": "gemini-3.1-flash-lite-paid",
        "video_summary_model": "gemini-3.1-flash-lite-paid",
    ...
    "gemini_free": {
        ...
        "audio_summary_model": "gemini-3.1-flash-lite",
        "video_summary_model": "gemini-3.1-flash-lite",
